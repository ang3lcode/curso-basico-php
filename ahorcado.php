...
//inicilizamos el juego;
$choosen_word = $possible_words[rand(0,9)]; // escoge la palabra
$choosen_word = strtolower($choosen_word); // letras
$word_length = strlen($choosen_word); //strlen , mide la longitud de la palabra
